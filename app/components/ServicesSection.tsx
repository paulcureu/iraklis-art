...
export default function ServicesSection() {
  const services = [
    ...
    },
    {
      title: "Architect",
      description:
        "Designing architectural elements and structural components that seamlessly integrate artistic vision with functional excellence, creating harmonious spaces that stand the test of time.",
      icon: (
        <svg
          className='w-16 h-16'
          fill='none'
