  ...
  return (
    <>
      ...
      <section className='py-20 md:py-32 bg-secondary relative overflow-hidden'>
        <div className='absolute top-0 left-0 w-full h-32 bg-linear-to-b from-secondary-dark/5 to-transparent pointer-events-none'></div>
        <div className='container mx-auto px-6 max-w-5xl text-center relative z-10'>
          <div className='animate-fade-in-up'>
            <svg
              className='w-10 h-10 md:w-12 md:h-12 mx-auto mb-6 md:mb-8 text-accent opacity-50'
              fill='currentColor'
              viewBox='0 0 24 24'
            >
            ...
            <p className='text-base md:text-lg lg:text-xl text-primary-light font-medium tracking-widest uppercase'>
              - Friedrich Nietzsche
            </p>
          </div>
        </div>
      ...
      <section
        id='about'
        className='py-20 md:py-32 relative overflow-hidden bg-primary text-secondary'
      >
        <div
          ...
          <div className='md:w-1/2 text-center md:text-left animate-fade-in-up animation-delay-200'>
            ...
            <div className='space-y-6 md:space-y-8 text-base md:text-lg text-secondary/80 font-light leading-relaxed'>
              <p>
                ...
                marble into breathtaking works of art that capture the essence
                of classical beauty and modern sensibility.
              </p>
              <p>
                His dedication to craftsmanship and his profound understanding
                of form and texture are evident in every piece. Iraklis's
                sculptures often explore themes of mythology, human emotion, and
                the natural world, inviting viewers into a dialogue with
                timeless narratives.
              </p>
              <div className='pt-4'>
                <a
                  href='/contact'
                  className='inline-block px-6 md:px-8 py-3 border border-accent text-accent hover:bg-accent hover:text-primary transition-all duration-300 uppercase tracking-widest text-xs md:text-sm font-medium'
                >
                  Get in Touch
                </a>
              </div>
